        ...
        <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
          <div className="relative mx-auto max-w-7xl px-0 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-lg sm:m-0 mx-12">
              <h1 className="font sm:text-4xl text-3xl font-bold tracking-tight text-stone-900 dark:text-white sm:text-6xl text-left">
                Mayble Chang
              </h1>
              <br></br>
              <h1 className="font sm:text-2xl text-xl font-bold tracking-tight text-stone-900 dark:text-white sm:text-4xl text-left">
                哈嘍ヾ(๑•̀∀•́๑)ツ，我是張郁梅
              </h1>
                ...
                >
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                    ...
                    <img
                      ...
                      alt="古埃及熊麻獻祭圖"
                      className="h-full w-full transition-all duration-300 cursor-pointer filter scale-100 stonescale hover:stonescale-0 hover:scale-95"
